# socialsimullm/utils/global_methods.py
...
def _get_template_path():
    """Get the path to town_data_template.json from the package data directory."""
    return os.path.join(os.path.dirname(__file__), '..', 'data', 'town_data_template.json')
...
def load_town_data(project_folder):
    ...
    if not os.path.exists(json_path):
        current_json_path = _get_template_path()
