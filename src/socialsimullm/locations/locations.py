# socialsimullm/locations/locations.py
...
class Location:
    ...
    A class that represents a location in the simulated environment.
...
class Locations:
    ...
    A class that represents a collection of locations in the simulated environment.
