...
def rate_experience(self, locations, global_time, prompt_meta, nearby_situations, experience):
    """
    Rates the agent's experience based on the agent's preferences and experiences.
    """
    system = rate_experiences_system
    prompt = rate_experiences_prompt.format(self.name, self.hourly_plans, global_time, locations.get_location(self.location), self.description, nearby_situations, experience)
